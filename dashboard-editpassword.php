...
if (newPassword === "") {
    ...
    $("#newPassword").addClass("is-invalid");
    $("<div class='text-danger error-message'>Password must contain at least one uppercase letter and one number.</div>").insertAfter("#newPassword");
} else if (newPassword.length < 8) {
    $("#newPassword").addClass("is-invalid");
    $("<div class='text-danger error-message'>Password must be at least 8 characters long.</div>").insertAfter("#newPassword");
}

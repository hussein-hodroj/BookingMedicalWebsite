    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="row" >
            <div class="col-lg-12  justify-content-center align-items-center  ">
                <div class="card shadow shadow-primary "style="box-shadow: 0 0 10px 0 rgba(24, 117, 216, 0.5);border-top: solid rgb(83, 158, 245)">
                    <div class="card-header" align="left">
                <h5 class=" card-title fw-medium p-1 m-0  text-muted" style="font-family:'Times New Roman', Times, serif ;"> The Field Below Are Required To Be Able To Use Your Account </h5>
            </div>
            <div class="card-body" align="left">
                <div class="form-group">
                    <label > Full Name </label>
                <input type="text" id="fullName" class="form-control shadow-sm p-2 mb-2 mt-2 bg-white " placeholder="Enter Your Name" required>   
            </div>
            <div class="form-group"> 
                <label > Address </label>
            <input type="text" id="address" class="form-control shadow-sm p-2 mb-2 mt-2 bg-white " placeholder="Enter Your Address" required>   
        </div>
        <div class="form-group">
            <label > E-mail </label>
        <input type="email" id="email" class="form-control shadow-sm p-2 mb-2 mt-2 bg-white " placeholder="Enter Your Email" required>   
    </div>
    <div class="form-group">
        <label > Phone Number </label>
    <input type="text" id="phoneNumber" class="form-control shadow-sm p-2 mb-2 mt-2 bg-white " placeholder="Enter Your Phone Number" required>   
</div>
